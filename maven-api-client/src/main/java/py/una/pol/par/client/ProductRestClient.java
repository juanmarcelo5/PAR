...
public class ProductRestClient {
    ...
    public ArrayList<Product> getProducts() {
        ...
        WebTarget target = client.target("http://localhost:8081/maven-api-rest/rest/pmcs/products");
    ...
    public Product getProductById(Integer id) {
        Client client = ResteasyClientBuilder.newClient();
        WebTarget target = client.target("http://localhost:8081/maven-api-rest/rest/pmcs/products/" + id);
        Response response = target.request().get();
    ...
    public Category getCategoryById(Integer id) {
        Client client = ResteasyClientBuilder.newClient();
        WebTarget target = client.target("http://localhost:8081/maven-api-rest/rest/pmcs/categories/" + id);
        Response response = target.request().get();
    ...
    public Category getCategoryByProductId(Integer id) {
        Client client = ResteasyClientBuilder.newClient();
        WebTarget target = client.target("http://localhost:8081/maven-api-rest/rest/pmcs/categories/product/" + id);
        Response response = target.request().get();
        Category values = response.readEntity(Category.class);
        response.close();
        return values;
    ...
    public ArrayList<Category> getCategories() {
        Client client = ResteasyClientBuilder.newClient();
        WebTarget target = client.target("http://localhost:8081/maven-api-rest/rest/pmcs/categories");
        Response response = target.request().get();
